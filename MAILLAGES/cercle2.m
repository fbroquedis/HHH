function cercle2(rayon1,rayon2,nbpoints1,nbpoints2,a1,a2)
%angle=pi/12;
...
for i=0:nbpoints1-1
  ...
  for i=0:nbpoints2-1
  X(:,nbpoints1+i+1)=[nbpoints1+i+1;rayon2*cos(i*angle2);rayon2*sin(i*angle2);3];
end
...
Y(:,nbpoints1+1)=[nbpoints1+1;nbpoints1+1;nbpoints1+2;3];
Y(:,nbpoints)=[nbpoints;nbpoints;nbpoints1+1;3];
...
fid=fopen(['cercle_asymp.poly'],'wt');
