SUBROUTINE sub_writeregular_vero_inc
  Use m_mesh
  Use m_output
  Use m_gen
  Use m_mat
  ...
  open(20,FILE="FILM_oeuf_3_1_5_et_2_1_onde_inc/rampant/frequence_1_bis/test."//trim(nam)//".vti")
...
!   write(20,*) '</VTKFile>' 
close(20)
END SUBROUTINE sub_writeregular_vero_inc
