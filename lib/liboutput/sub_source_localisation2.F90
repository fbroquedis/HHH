SUBROUTINE sub_source_localisation2
      Use m_mesh
      Use m_gen
      Use m_source
	...
	Valphisource=0.
      ...
      DO I=1,Ntri
	    ...
	    CASE(2)
            ...
            CASE(3)
		! write(6,*) 'test',coord_s_ref(1),coord_s_ref(2),1,ValPhisource
         ...
         END IF
      ENDDO
END SUBROUTINE sub_source_localisation2
