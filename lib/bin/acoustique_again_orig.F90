...
REAL*8,allocatable :: Phi(:,:)
    ...
    integer :: index_start,index_end,ptr_index1,ptr_index2
...
!! How to read Neigh : triangle Neigh(I,1) is a neighbourg of triangle I. They are connected by edge Tri(I,2),Tri(I,3).
  ! a-t-on autre chose que Neumann sur le bord
    ...
    END IF
  END DO
  READ(20,*) inner_count,border_count
     ...
     DO I=1,Ntri
        ...
        DO J=1,3
           IF (Neigh(I,J).gt.0) then
              AU((I-1)*Nphi3+1:I*Nphi3)=AU((I-1)*Nphi3+1:I*Nphi3)-MATMUL(A(1:Nphi3,J*Nphi3+1:(J+1)*Nphi3,I)&
