subroutine sub_error_abs_scalaire_vectoriel_courbe2(error_p, error_ux, error_uy,R0)
	Use m_mat
	Use m_gen
	Use m_mesh
	implicit none
...
End Do
	...
	error_p=sqrt(error_p)
      ...
      end subroutine sub_error_abs_scalaire_vectoriel_courbe2

subroutine sub_error_rel_scalaire_vectoriel_courbe2(error_p,error_ux,error_uy,R0)
	Use m_mat
	Use m_gen
	Use m_mesh
	implicit none
...
end subroutine sub_error_rel_scalaire_vectoriel_courbe2
