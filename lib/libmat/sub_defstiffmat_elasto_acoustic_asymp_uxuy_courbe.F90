SUBROUTINE sub_defstiffmat_elasto_acoustic_asymp_uxuy_courbe(R0)
  Use m_mat
  Use m_gen
  Use m_mesh
  implicit none
...
If(helmholtz.eq.1) then
              A_uxuy(Iloc,L,Q)=A_uxuy(Iloc,L,Q)-res
else
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
END SUBROUTINE sub_defstiffmat_elasto_acoustic_asymp_uxuy_courbe
