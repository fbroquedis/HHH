SUBROUTINE sub_defstiffmat_elasto_acoustic_asymp_uyuy
  Use m_mat
  Use m_gen
  Use m_mesh
  implicit none
...
!! Computation of p*u_x
        DO J=1,Order+1
           DO K=1,Order+1
              res=PhiIPhiJ(J,K)*norm(Arete,2)**2*dsqrt(mu(Ineigh)*rho(Ineigh))
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
END SUBROUTINE sub_defstiffmat_elasto_acoustic_asymp_uyuy
