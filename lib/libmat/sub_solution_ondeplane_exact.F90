subroutine sub_solution_ondeplane_exact_grad(theta0)
  Use m_condbord    
  Use m_mat
  Use m_gen
  Use m_mesh
  ...
  CASE(3)
     ...
     enddo
  ENDSELECT
end subroutine sub_solution_ondeplane_exact_grad

subroutine sub_solution_ondeplane_exact_rot(theta0)
  Use m_condbord    
  Use m_mat
  Use m_gen
  Use m_mesh
  ...
  CASE(3)
     ...
     enddo
  ENDSELECT
end subroutine sub_solution_ondeplane_exact_rot
