SUBROUTINE sub_defstiffmat_elasto_acoustic_pp_courbe
  Use m_mat
  Use m_gen
  Use m_mesh
  implicit none
  INTEGER :: I,INeigh,Node(3),J,K,L,L1,Q,Arete,Arete_neigh,arete_courbe
...
END SUBROUTINE sub_defstiffmat_elasto_acoustic_pp_courbe
