SUBROUTINE sub_defstiffmat_elasto_acoustic_uxp_courbe(R0)
  Use m_mat
  Use m_gen
  Use m_mesh
  implicit none
...
If(helmholtz.eq.1) then
              A_uxp(Iloc,L,(Arete-1)*Nphi+Q)=A_uxp(Iloc,L,(Arete-1)*Nphi+Q)+res
else
              A_uxp(Iloc,L,(Arete-1)*Nphi+Q)=A_uxp(Iloc,L,(Arete-1)*Nphi+Q)+res
endif
           END DO
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
END SUBROUTINE sub_defstiffmat_elasto_acoustic_uxp_courbe
