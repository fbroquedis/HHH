SUBROUTINE sub_defstiffmat_elasto_acoustic_asymp_dir_uyuy_courbe(epsilon,R0)
  Use m_mat
  Use m_gen
  Use m_mesh
  implicit none
  ...
  REAL*8 :: Jfinv(2,2),V(3,2),Test(3),cmax,V_voisin(3,2),normal(2)
...
!                 d=d+sum(pt_courbe_y*gradphi1D(:,L))**2
                ...
                d=sqrt(normal(1)**2+normal(2)**2)
                 res=res+Phi(J,L)*Phi(K,L)*wGL1D(L)*normal(2)**2/d
              ENDDO
              res=res*rho(Ineigh)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
END SUBROUTINE sub_defstiffmat_elasto_acoustic_asymp_dir_uyuy_courbe
