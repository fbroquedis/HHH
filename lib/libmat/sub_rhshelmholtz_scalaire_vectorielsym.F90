subroutine sub_rhshelmholtz_scalaire_vectorielsym(F,theta0)
 Use m_condbord    
  Use m_mat
  Use m_gen
  Use m_mesh
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!! Attention
!!!! On a besoin de -i*omega*p_incident (la dérivée en temps)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
F(I+PhiEdge(int_j,K),1) = F(I+PhiEdge(int_j,K),1)&
     &+cmplx(0,omega)*d*sum(Phi(K,:)*Valsourcebord(:)*wGL1D)*norm(int_j,1)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!! Calcul de  -i*omega*p_incident*n_y
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
F(I+Nphi+PhiEdge(int_j,K),1) = F(I+Nphi+PhiEdge(int_j,K),1)&
     &+cmplx(0,omega)*d*sum(Phi(K,:)*Valsourcebord(:)*wGL1D)*norm(int_j,2)
              end do
           end IF
...
end subroutine sub_rhshelmholtz_scalaire_vectorielsym
