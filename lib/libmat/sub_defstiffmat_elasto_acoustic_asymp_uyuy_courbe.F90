SUBROUTINE sub_defstiffmat_elasto_acoustic_asymp_uyuy_courbe(R0)
  Use m_mat
  Use m_gen
  Use m_mesh
  implicit none
...
!! Computation of p*u_x
        DO J=1,Order+1
           DO K=1,Order+1
              ...
              res=res*norm(Arete,2)**2*dsqrt(mu(Ineigh)*rho(Ineigh))
              res=res*(0D0,1D0)*omega
              L=PhiEdge(Arete,J)
              Q=PhiEdge(Arete,K)
!phi_I,L*phi_I_neigh,Q
If(helmholtz.eq.1) then
              A_uyuy(Iloc,L,Q)=A_uyuy(Iloc,L,Q)-res
else
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
END SUBROUTINE sub_defstiffmat_elasto_acoustic_asymp_uyuy_courbe
